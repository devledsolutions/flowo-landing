/**
 * Reprodução exata do hero do fora.so com conteúdo Flowo (commit d1d95d1).
 * Mantida como referência de mecanismo e medidas; não é renderizada. Para
 * compará-la, troque o import em app/page.tsx (ver comentário lá).
 */
...
export default function HeroForaExact() {
  return (
    <ParallaxPlanes
      id="hero"
