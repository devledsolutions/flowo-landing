...
export const COMPETITOR_COMPARISONS: readonly CompetitorComparison[] = [
  {
    ...
    priceSummary:
      `O Flowo começa em ${FLOWO_SOLO_PRICE}/mês. A jornada pública é paga; a equipe pode conceder uma avaliação assistida de 14 dias a clientes elegíveis do Solo ou Equipe. O AppBarber mostra plano mensal a partir de R$ 79,90 para um profissional e teste grátis de 30 dias. Confirme as condições vigentes.`,
    keyDifferences: [
  ...
  },
  {
    ...
    priceSummary:
      `O Flowo começa em ${FLOWO_SOLO_PRICE}/mês. O Barbeiro.app publica plano gratuito, Pro a partir de R$ 59,90/mês e Enterprise a partir de R$ 139,90/mês para 1 a 2 profissionais. Assistente de IA e WhatsApp Pro aparecem como complementos nos planos aplicáveis; a IA é incluída no Enterprise. Compare o pacote completo e os limites vigentes.`,
    keyDifferences: [
  ...
  },
  {
    ...
    priceSummary:
      `O Flowo publica três planos a partir de ${FLOWO_SOLO_PRICE}/mês. A Avec mostra R$ 88,90/mês para 1 a 2 profissionais na opção anual e valores sob consulta nas faixas seguintes; WhatsApp integrado, Avec IA, pagamentos e outros itens aparecem como recursos adicionais na tabela pública.`,
    keyDifferences: [
  ...
  },
  {
    ...
    snapshotRows: [
      ...
      { criterion: "Entrada publicada", flowo: `${FLOWO_SOLO_PRICE}/mês`, competitor: "R$ 94,90/mês" },
    ],
    priceSummary:
      `O Flowo começa em ${FLOWO_SOLO_PRICE}/mês. A Graces publica plano mensal a partir de R$ 94,90 para até três profissionais e anual a partir de R$ 79,90/mês; automação de WhatsApp, IA e fiscal são apresentados na área de módulos. Confirme o pacote aplicável.`,
    keyDifferences: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          `Na verificação de 31 de julho de 2026, a Graces publicava preço mensal a partir de R$ 94,90 e o Flowo a partir de ${FLOWO_SOLO_PRICE}. Compare também quais módulos são necessários e se a IA no WhatsApp está incluída na configuração escolhida.`,
      },
      {
  ...
  },
  {
    ...
    priceSummary:
      `O Flowo publica Solo por ${FLOWO_SOLO_PRICE} e Equipe por ${FLOWO_EQUIPE_PRICE} por mês; o Empresarial é sob consulta. A avaliação assistida de 14 dias pode ser concedida a clientes elegíveis do Solo ou Equipe. O Barva oferece sete dias de teste e monta uma proposta conforme profissionais e módulos.`,
    keyDifferences: [
  ...
  },
  {
    ...
    priceSummary:
      `O Flowo começa em ${FLOWO_SOLO_PRICE}/mês. A jornada pública é paga; clientes elegíveis do Solo ou Equipe podem receber uma avaliação assistida de 14 dias. A Opero publica quatro planos de R$ 59 a R$ 299/mês e teste de sete dias. Confirme limites e capacidades na proposta vigente.`,
    keyDifferences: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          `A Opero publica entrada de R$ 59/mês e o Flowo começa em ${FLOWO_SOLO_PRICE}/mês. Compare os limites de profissionais, números, notificações, implantação e recursos necessários em cada plano.`,
      },
      {
